...
import { Box, Typography, Paper, Container, Divider, Stack, TextField, Snackbar, Alert } from '@mui/material';
          ...
          <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, alignItems: 'center', gap: 4 }}>
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                ...
                Recommended image size: 250x250 pixels. Maximum file size: 2MB.
              </Typography>
            </Box>
          </Box>
        </Paper>
